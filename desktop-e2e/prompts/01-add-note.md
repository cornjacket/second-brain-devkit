...
Paste into Claude Desktop (connected to the fixture brain):

```
Use the add_note tool to create a note.
Title: Planning agents
PARA root: resources
Body: A note about planning agents, written for the desktop e2e fixture.
...
Verify:
```
python3 desktop-e2e/verify/verify_01_add_note.py --brain /tmp/e2e-brain
```
