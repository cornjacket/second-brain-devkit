...
- possibly a note about how many existing notes it linked (the cascade); zero is fine on a fresh
  fixture.

Verify:
```
python3 desktop-e2e/verify/verify_03_glossary.py --brain /tmp/e2e-brain
```
